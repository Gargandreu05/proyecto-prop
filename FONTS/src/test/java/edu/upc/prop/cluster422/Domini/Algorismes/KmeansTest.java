...
/**
 * Test unitari (amb integració de dades) per a la classe Kmeans.
 * Aquest test comprova que l'algorisme convergeix al resultat esperat
...
public class KmeansTest {
    ...
    public void testExecutaAlgorisme() throws CustomException {
        ...
        Map<Integer, Cluster> resultats = kmeans.executa(mockEnquesta, 2);
        ...
        // Com que la inicialització és aleatòria, no sabem quin clúster serà el 0 i quin l'1.
